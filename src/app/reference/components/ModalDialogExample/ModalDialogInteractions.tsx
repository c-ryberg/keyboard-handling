  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <kbd>Escape</kbd>: Closes the dialog. When the dialog closes, focus
          usually returns to the element that invoked the dialog. See note below
          for further details.
        </li>
      </ul>

      <details>
        <summary>Expand to read Dialog Notes</summary>
        <Note>
          <ol>
            <li>
              ...
              <ul>
                <li>
                  ...
                  lists, tables, or multiple paragraphs, that need to be
                  perceived in order to easily understand the content, i.e., if
                  the content would be difficult to understand when announced as
                  a single unbroken string, then it is advisable to add{" "}
                  ...
                  advisable to omit applying <code>aria-describedby</code> to
                ...
                <li>
                  ...
                  <a href="https://www.w3.org/WAI/ARIA/apg/patterns/alertdialog/">
                ...
                <li>
                  ...
                  advisable to set focus to the element that is likely to be
                  most frequently used, such as an <q>OK</q> or <q>Continue</q>{" "}
                  button.
                </li>
              </ul>
            </li>
            <li>
              When a dialog closes, focus returns to the element that invoked
              the dialog unless either:
              <ul>
                <li>
                ...
                <li>
                  The work flow design includes the following conditions that
                  can occasionally make focusing a different element a more
                  logical choice:
                  <ol>
                    <li>
                      It is very unlikely users need to immediately re-invoke
                      the dialog.
                    </li>
                    <li>
                  ...
                  For example, a grid has an associated toolbar with a button
                  for adding rows. The Add Rows button opens a dialog that
                  prompts for the number of rows. After the dialog closes, focus
                  is placed in the first cell of the first new row.
                </li>
              </ul>
            </li>
            <li>
              It is strongly recommended that the tab sequence of all dialogs
              include a visible element with role <code>button</code> that
              closes the dialog, such as a close icon or cancel button.
            </li>
          </ol>
        </Note>
      </details>
